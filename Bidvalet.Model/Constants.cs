...
namespace Bidvalet
{
	public static class Constants
	{
		...
		public static List<string> ErrorMessages = new List<string> {
			...
			"",
			"",
			"Welcome! Your account is free for the month.\n\nNext we are going to have you set your filter criteria.\n\nYou can set things like AMs before PMs, no international, Sat & Sun off, 23rd and 29th off, etc.\n\nIf you are a Fit Att don’t worry about position just yet",
			"Your Subscription expired on\n 17 Sep 2015\n\nYou can subscribe here for $5.99 a one month usage.\n\nOr you can go to www.wbidmax.com for additional account options.",
			"Great! You have a valid subscription!\n\nNext we are going to have you set your filter criteria.\n\nYou can set things like AMs before PMs, no international, Sat & Sun off, 23rd and 29th off, etc.\n\nDon’t worry about position just yet",
			"Next, we are going to have you set your FILTER criteria.\n\nYou can set things like:\n  - AMs before PMs\n  - No international\n  - Sat & Sun off\n  - 23rd and 29th off\n  - etc.",
            "Oops!\n\nYou are not having an account in WBid.\n\nPlease create an Account.",
            "You cannot get needed access via SouthwestWifi or 2Wire.  \n\nTry again later when you are safely on the ground and have another internet access",
            "We are not able to connect to the WBidMax server.Please check your Internet connection and  try again later.  \n\nIf this persists, you can try to change internet connections (like use a hotspot). \n\nFinally, if this persists for more than 4 hours, let us know."
...
//			"Blank-Reserve",
		...
		public static string TITLE_PRINT = "Printer";
