...
namespace Bidvalet
{
	public class BidDetails
	{
		...
		/// Flight Attendants: Feb bid period starts on 31 Jan, Mar bid period 

		/// starts on 2 Mar, all other months start on the 1st
		...
		/// Flight Attendants:  Jan bid period ends on 30 Jan, Feb bid period ends 

		/// on 1 Mar, all other bid periods end on the last day of the month
