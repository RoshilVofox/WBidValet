...
namespace Bidvalet.Model.OldLine
{
	...
	public class OldLine
	{
		...
		// if the value is 0, it indicates the normal line
		//if the value is 1, it indicates the line moved from below this line(need to show blue line)
		//if the value  is 2, it indicates the line moved.(need to show blue border)
