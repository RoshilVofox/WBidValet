...
namespace Bidvalet.Business.BusinessLogic
{
    public class FVVacation
    {
        ...
        public List<Line> SetFVVacationValuesForAllLines(List<Line> lines)
        {
            try
            {
            ...
            try
            {
                ...
                if (isLeftSideVacation)
                {
                    ...
                    if (Righttripsinside.FirstOrDefault() == null)
                    {
                        ...
                        Righttripsinside.Add(new FVVacationData { StartDate = RightnewFVFdate.FirstOrDefault().StartAbsenceDate, EndDate = RightnewFVFdate.FirstOrDefault().EndAbsenceDate });
                ...
                else if (isRightSideVacation)
                {
                    if (lefttripsinside.FirstOrDefault() == null)
                    {
                        ...
                        lefttripsinside.Add(new FVVacationData { StartDate = LeftnewFVFdate.FirstOrDefault().StartAbsenceDate, EndDate = LeftnewFVFdate.FirstOrDefault().EndAbsenceDate });
                    }
                    FVvacationLineData = SetValuesForFVVacations(line, lefttripsinside.FirstOrDefault(), ref FVvacationLineData);
                }
                else
