...
namespace Bidvalet.Shared
{
	public class ModifiedSeniorityListParser
	{
		...
		/// <returns></returns>
		//public List<SeniorityListMember> ParseSeniorityListForPilot(string filePath, string position, int year, int month, string round)
		//{
        ...
        public List<SeniorityListMember> ParseSeniorityListForPilot(string filePath, string position, int year, int month, string round,SenListFormat senlist)
        {
            ...
            SenListMembers = new List<SeniorityListMember>();
            SenListMembers = ParseSeniorityListForPilotForFirstRoundUsinfDBValues(filePath, position, year, month);
            return SenListMembers;

        }
        public List<SeniorityListMember> ParseSeniorityListForPilotForFirstRoundUsinfDBValues(string filePath, string position, int year, int month)
        {
            try
            {
                SenListMembers = new List<SeniorityListMember>();
